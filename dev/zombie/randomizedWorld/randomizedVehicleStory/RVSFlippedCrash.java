    ...
    public void spawnElement(final VehicleStorySpawner vehicleStorySpawner, final VehicleStorySpawner.Element element) {
        ...
        switch (id) {
            case "vehicle1": {
                ...
                setSmashed.setBloodIntensity("Front", Rand.Next(0.3f, 1.0f));
                setSmashed.setBloodIntensity("Rear", Rand.Next(0.3f, 1.0f));
                setSmashed.setBloodIntensity("Left", Rand.Next(0.3f, 1.0f));
                setSmashed.setBloodIntensity("Right", Rand.Next(0.3f, 1.0f));
