...
public final class AlarmClockClothing extends Clothing
{
    ...
    public AlarmClockClothing(final String s, final String s2, final String s3, final String s4, final String s5, final String s6) {
    ...
    public AlarmClockClothing(final String s, final String s2, final String s3, final Item item, final String s4, final String s5) {
        super(s, s2, s3, item, s4, s5);
        this.alarmHour = -1;
        this.alarmMinutes = -1;
        this.alarmSet = false;
        this.ringSince = -1.0;
    ...
    public void updateSound(final BaseSoundEmitter baseSoundEmitter) {
        ...
        if (GameClient.bClient && AlarmClockClothing.sendEvery.Check() && this.isInLocalPlayerInventory()) {
    ...
    public void syncAlarmClock_Player(final IsoPlayer isoPlayer) {
        if (GameClient.bClient) {
            ...
            startPacket.putShort(AlarmClockClothing.PacketPlayer);
    ...
    public void syncAlarmClock_World() {
        if (GameClient.bClient) {
            final ByteBufferWriter startPacket = GameClient.connection.startPacket();
            PacketTypes.PacketType.SyncAlarmClock.doPacket(startPacket);
            startPacket.putShort(AlarmClockClothing.PacketWorld);
    ...
    static {
        AlarmClockClothing.PacketPlayer = 1;
        AlarmClockClothing.PacketWorld = 2;
