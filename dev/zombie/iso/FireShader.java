...
public class FireShader extends Shader
{
    ...
    public FireShader(final String s) {
        super(s);
    }
    ...
    public void updateFireParams(final TextureDraw textureDraw, final int n, final float n2) {
        final ParticlesFire instance = ParticlesFire.getInstance();
        GL13.glActiveTexture(33984);
        instance.getFireFlameTexture().bind();
