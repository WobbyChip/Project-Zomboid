...
function onServerCommand(module, cmd, args)
	print('CT onServerCommand:'..module)
	print('CT onServerCommand:'..cmd)
end

function onClientCommand(module, cmd, player, args)
	print('CT onClientCommand:'..module)
	print('CT onClientCommand:'..cmd)
end
